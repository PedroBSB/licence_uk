...
#Estimates
stargazer(multi1, type="html", out="multi1_12_05_2017_private.htm")
```

```{r, echo=FALSE,eval=TRUE,message=FALSE,warning=FALSE, results='asis'}
#Relative risk ratios
multi1.rrr = exp(coef(multi1))
stargazer(multi1, coef=list(multi1.rrr), p.auto=FALSE,  type="html", out="rrrmulti1_12_05_2017_private.htm")
```
...
```{r, echo=FALSE,eval=TRUE,message=FALSE,warning=FALSE, results='asis'}
#Estimates
stargazer(multi1, type="html", out="multi2_12_05_2017_private.htm")
```

```{r, echo=FALSE,eval=TRUE,message=FALSE,warning=FALSE, results='asis'}
#Relative risk ratios
multi1.rrr = exp(coef(multi1))
stargazer(multi1, coef=list(multi1.rrr), p.auto=FALSE,  type="html", out="rrrmulti2_12_05_2017_private.htm")
```
...
```{r, echo=FALSE,eval=TRUE,message=FALSE,warning=FALSE, results='asis'}
#Estimates
stargazer(multi1, type="html", out="multi3_12_05_2017_private.htm")
```

```{r, echo=FALSE,eval=TRUE,message=FALSE,warning=FALSE, results='asis'}
#Relative risk ratios
multi1.rrr = exp(coef(multi1))
stargazer(multi1, coef=list(multi1.rrr), p.auto=FALSE,  type="html", out="rrrmulti3_12_05_2017_private.htm")
```